...
public class BasicPortalController : MonoBehaviour
{
    ...
    /// </summary>
    [SerializeField] private BasicPortalController foreignPortal;
    ...
    void OnTravellerEnterBasicPortal(PortalTeleportManager traveller)
    {
    ...
    void TeleportTraveller()
    {
        for (int i = 0; i < trackedTravellers.Count; i++)
        {
            ...
            if (portalSlide != portalSlideOld)
            {
                ...
                foreignPortal.OnTravellerEnterBasicPortal(traveller);
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (traveller)
        {
            OnTravellerEnterBasicPortal(traveller);
        }
    }
