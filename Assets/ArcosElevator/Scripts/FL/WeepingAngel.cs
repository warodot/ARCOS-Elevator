...
public class WeepingAngel : MonoBehaviour
{
    ...
    bool IsCameraLookingAtAngel()
    {
        ...
        if (dotProduct < 0) // Si el dotProduct es negativo, la cámara está mirando en dirección al ángel
        {
            return IsAngelVisibleFromCamera(); // Verifica si el ángel está dentro del campo de visión
        }
        return false;
    }
